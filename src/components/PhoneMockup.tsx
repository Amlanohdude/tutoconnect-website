            ...
            <div className="relative h-[605px] flex flex-col bg-[#F8FAFC] text-left overflow-hidden">
              ...
              <div className="bg-gradient-to-b from-[#1D4ED8] via-[#2563EB] to-[#2563EB] pt-8 pb-3.5 px-3 rounded-b-[24px] shadow-sm flex-shrink-0 relative z-20">
                ...
                <div className="mt-3 flex items-center gap-2">
                  <div className="flex-1 bg-white rounded-full px-3 py-2 flex items-center gap-2 shadow-xs">
                  ...
                  <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-[#2563EB] shadow-xs flex-shrink-0 hover:bg-blue-50 transition-colors cursor-pointer">
              ...
              <div className="absolute bottom-0 inset-x-0 bg-white border-t border-[#E2E8F0] px-4 pt-2 pb-1.5 z-30 shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
                ...
                {/* Android Bottom Home Bar Indicator */}
                <div className="w-24 h-1 bg-neutral-300 rounded-full mx-auto mt-2 mb-0.5" />
              </div>
            </div>
          )}
